...
public class EntityUtils
{
	...
	public static EntityLivingBase getRandomLivingEntity (World world, List blacklist, int numberOfAttempts, List<SimpleEntry<UUID, String>> fallbackPlayerNames)
	{
		...
		if (blacklist != null) entities.removeAll(blacklist);
		...
		if (!EntityLivingBase.class.isAssignableFrom(clazz))
		{
			...
			else return (EntityLivingBase) EntityList.createEntityByName("Chicken", world);
		}

		if (bspkrsCoreMod.instance.allowDebugOutput) BSLog.info(entStrings[id].toString());
