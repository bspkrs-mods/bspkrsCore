...
public class bspkrsCoreMod
{
	...
	public void syncConfig ()
	{
		...
		if (Reference.config.hasCategory(ctgyGen + ".example_properties")) Reference.config.removeCategory(Reference.config.getCategory(ctgyGen + ".example_properties"));
	...
	{
		if (generateUniqueNamesFile) UniqueNameListGenerator.instance().run();
	}

	@EventHandler
	public void serverStarting (FMLServerStartingEvent event)
	{
		if (!isCommandRegistered) event.registerServerCommand(new CommandBS());
	}
