...
// this class is broken seeing as getItemRegistry() is @Deprecated
@Deprecated
public class ItemID
{
	/**
	...
	public boolean equals (Object obj)
	{
		...
		ItemID o = (ItemID) obj;
		if ( (o.damage == -1) || (damage == -1)) return id != null ? id.equals(o.id) : o.id == null;
		else return id != null ? id.equals(o.id) && (damage == o.damage) : (o.id == null) && (damage == o.damage);
	}
