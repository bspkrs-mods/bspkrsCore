...
public class BSConfiguration extends Configuration
{
	...
	// public static void renameCtgy(Configuration config, String oldCtgy,
	// String newCtgy)
	// {
	// if (!oldCtgy.equalsIgnoreCase(newCtgy))
	// {
	// for (String prop : config.getCategory(oldCtgy).keySet())
	// config.get(newCtgy, prop,
	// config.getCategory(oldCtgy).get(prop).getString());
	//
	// Map<String, HashMap<String, String>> toAdd = new HashMap<String,
	 ...
	 * @param defaultValue Default value of the property.
	 * @param comment A brief description what the property does.
	 * @param validValues A list of valid values that this property can be set
	 * to.
	 * @return The value of the new string property.
	 */
	@Override
